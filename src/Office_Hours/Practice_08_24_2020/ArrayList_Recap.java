...
public class ArrayList_Recap {
    public static void main(String[] args) {
        ...
        names.addAll(Arrays.asList("Ahmed", "Elkem", "Cristina", "Ahmed", "Ahmed"));

        names.removeIf(p-> p.equalsIgnoreCase("Ahmed"));
        System.out.println(names);

        ArrayList<Integer> grades = new ArrayList<>();
        grades.addAll(Arrays.asList(50,65,45,75,85,95,100,87,40,52,62,35));

        grades.removeIf(p-> p<60);
        System.out.println(grades);

        ArrayList<String> students = new ArrayList<>();
        students.addAll(Arrays.asList("Viorel", "Askat", "Ziiadin", "Dilfure", "Ziiadin"));
